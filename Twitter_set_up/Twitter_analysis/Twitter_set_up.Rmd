...
```
As we see above the most frequent words used words are Learning ,machine are the most frequent words in the text on the Machine Learning Page.
...
```
As we see majority words are positive ,so majority of Twittes are positive.
